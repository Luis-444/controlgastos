<x-normal-layout>
    <x-slot name="actionSlot">
        <x-icons.add class="icon__pointer" tooltip="Registra una categoria" tooltip_aling="bottom" wire:click="newCategoryModal()"/>
                    ...
                    <tr>
                        <td>
                            <div class="flex__container__center">
                                <x-icons.edit class="icon__pointer" wire:click="editCategory({{$c->id}})" tooltip="Editar" />
                                <x-icons.trash class="icon__pointer" wire:click="categoryToDestroy({{$c->id}})" tooltip="Eliminar" tooltip_aling="top"/>
                            </div>
                        </td>
                        <td>{{$c->name}}</td>
                    </tr>
    ...
    {{-- Modales --}}
    <x-dialog-modal wire:model="newCategoryModal">
        <x-slot name="title" >
            Nueva categoria
        </x-slot>
        <x-slot name="content">
        ...
        <x-slot name="footer">
            <x-button class="button-primary" wire:click="newCategory">
                Aceptar
            </x-button>
    ...
    <x-dialog-modal wire:model="editCategoryModal">
        <x-slot name="title" >
            Editar categoria
        </x-slot>
        <x-slot name="content">
        ...
        <x-slot name="footer">
            <x-button class="button-primary" wire:click="updateCategory">
                Aceptar
            </x-button>
            <x-button class="button-danger" wire:click="erase">
                Cancelar
